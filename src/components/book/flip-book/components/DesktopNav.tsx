  ...
  return (
    ...
    >
      <button
        ...
        className="p-1 -ml-2 mr-2 rounded-lg text-muted-foreground hover:text-foreground hover:bg-accent transition-colors"
      >
      ...
      <button
        ...
        className="p-1.5 rounded-lg text-muted-foreground hover:text-foreground bg-card border border-border hover:bg-accent transition-colors ml-1"
        title={t.header?.search || 'Ara'}
      >
