...
interface MobileAuthorSheetProps {
  open: boolean;
  onClose: () => void;
  language: string;
...
export const MobileAuthorSheet = React.memo(function MobileAuthorSheet({
  open,
  onClose,
  language,
  onLanguageChange,
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isSelected ? 'bg-white/15 text-white' : 'text-white/80 hover:bg-white/10'
                    )}
                  >
